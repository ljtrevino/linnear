      ...
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" sm="6" md="4">
            <Card>
              <CardBlock className="card-body">
                <iframe src="6.006FinalCrib.pdf" width="100%" height="100%" >
                            This browser does not support PDFs. Please download the PDF to view it: <a href="6.006FinalCrib.pdf">Download PDF</a>
                </iframe>
              </CardBlock>
