      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 1</CardHeader>
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 2</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 3</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 4</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 5</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 6</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 7</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 8</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 9</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 10</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 11</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 12</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 13</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 14</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 15</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 16</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 17</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 18</CardHeader>
                <CardBlock className="card-body">
        ...
        <Row>
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 19</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 20</CardHeader>
                <CardBlock className="card-body">
          ...
          <Col xs="12" sm="6" md="4">
            ...
            >
              <Card className="card-accent-primary">
                <CardHeader>Lecture 21</CardHeader>
                <CardBlock className="card-body">
